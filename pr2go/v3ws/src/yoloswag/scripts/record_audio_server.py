...
"""
	TODO: record speech.noise-profile
	TODO: check speech.noise-profile is in the right directory
"""
...
def dothis(record_time, filename_base):
	...
	os.system('sox ' + output + ' ' + clean + ' noisered ' + path_to_speech_profile + ' 0.1')
